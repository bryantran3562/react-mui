...
import useCounter2Hook from './useCounter2Hook'
...
function Counter() {
    ...
    //BT - Then again we just used it in our file just like the pinia store.

    const [count, setMyCount] = useCounter2Hook()
    ...
    return (
        <div>
            ...
            */}
            <button onClick={() => setMyCount()}>Click Me</button>
        </div>
    )
}
